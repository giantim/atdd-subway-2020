...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine() {
        ...
        ExtractableResponse<Response> response =
                LineAcceptanceStep.지하철_노선_생성_요청("신분당선", "RED", 0);
    ...
    void getLines() {
        ...
        ExtractableResponse<Response> createResponse1 =
                LineAcceptanceStep.지하철_노선_등록되어_있음("신분당선", "RED", 0);
        ExtractableResponse<Response> createResponse2 =
                LineAcceptanceStep.지하철_노선_등록되어_있음("2호선", "GREEN", 0);
    ...
    void updateLine() {
        ...
        String name = "신분당선";
        ExtractableResponse<Response> createResponse =
                LineAcceptanceStep.지하철_노선_등록되어_있음(name, "RED", 0);
